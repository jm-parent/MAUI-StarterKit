...
public partial class DrawingSamplePage : ContentPage
{
	public DrawingSamplePage(DrawingSampleViewModel viewModel)
	{
		InitializeComponent();
    ...
    {
        var drawingLines = (BindingContext as DrawingSampleViewModel).Lines.ToList();
